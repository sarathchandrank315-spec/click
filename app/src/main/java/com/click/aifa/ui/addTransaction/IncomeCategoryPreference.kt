...
object IncomeCategoryPreference {

    private const val PREF_NAME = "income_category_pref"
    private const val KEY_CATEGORIES = "income_categories"
    private const val KEY_SELECTED = "income_selected_category"
